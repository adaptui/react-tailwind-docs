import { ComponentLinks, PropsTable } from "@/components/index";
...
```jsx live
<Box as="dl" class="grid grid-cols-1 gap-5 mt-5 sm:grid-cols-2">
  <Box class="px-4 py-5 overflow-hidden bg-white rounded-lg shadow sm:p-6">
